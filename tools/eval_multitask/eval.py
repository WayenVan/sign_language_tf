...
@click.option(
    "--config", "-c", default="outputs/train_lightning/2024-04-11_04-06-40/config.yaml"
)
@click.option(
    "-ckpt",
    "--checkpoint",
    default="outputs/train_lightning/2024-04-11_04-06-40/epoch=epoch=50_wer-val=val_wer=0.27_lr=lr=0.00_loss=train_loss_epoch=1.38.ckpt",
)
