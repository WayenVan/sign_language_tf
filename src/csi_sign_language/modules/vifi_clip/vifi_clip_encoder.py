...
class PromptLearner(nn.Module):
    ...
    def __init__(
        ...
        *args, **kwargs) -> None:
        ...
        scale = embed_dim ** -0.5
        self.prompt_embed = nn.Parameter(scale * torch.randn(num_prompts, embed_dim, dtype=torch.float32), requires_grad=True)
...
class ClipEncoder(nn.Module):
    ...
    def __init__(
        ...
        *args, **kwargs) -> None:
        ...
        #fusiong layer
        self.fusion = FeedForwardFusion(d_model, d_model * fusion_expand_factor)
    ...
    def forward(self, x, t_length):
        ...
        if local_prompt is None:
            ...
            x = self.fusion(torch.cat([cls.unsqueeze(1), prompts, local_prompt], dim=1))
