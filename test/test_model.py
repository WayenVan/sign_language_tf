...
class DebugCallback(Callback):
    ...
    def on_train_start(self, trainer, pl_module: LightningModule):
        ...
        #     print(name)
        return
    def on_train_batch_start(self, trainer, pl_module: LightningModule, batch, batch_idx):
    ...
    def on_before_optimizer_step(self, trainer: Trainer, pl_module: LightningModule, optimizer) -> None:
        # for name, param in pl_module.named_parameters():
...
def test_model():
    ...
    cfg = hydra.compose('run/train/heatmapres')
